    ...
    private func audioStyle(for theme: VisualTheme) -> AudioStyle {
        ...
        case .motorcade:
            return AudioStyle(
                ...
                gameOverRate: 0.90,
                menuLoopRate: 1.02,
                gameplayLoopRate: 1.04,
                effectVolumeScale: 1.06,
                musicVolumeScale: 1.02
            )
        case .police:
            return AudioStyle(
                effectRate: 1.00,
                ...
                menuLoopRate: 1.04,
                gameplayLoopRate: 1.06,
                effectVolumeScale: 1.08,
                musicVolumeScale: 1.00
            )
        case .construction:
            return AudioStyle(
                effectRate: 0.92,
                ...
                gameOverRate: 0.86,
                menuLoopRate: 0.94,
                gameplayLoopRate: 0.96,
                effectVolumeScale: 1.04,
                musicVolumeScale: 1.04
            )
        case .racing:
            return AudioStyle(
